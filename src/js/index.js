...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function hoverIn() {
        var hoverColor = currentTheme === 'light' ? reducedColorLight : reducedColorDark;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (savedTheme === 'light') {
        updateIcons(document.getElementById('light-mode-btn'), document.getElementById('dark-mode-btn'));
    } else {
        updateIcons(document.getElementById('dark-mode-btn'), document.getElementById('light-mode-btn'));
    }
});
...
function animateParticle(particle, container) {
    ...
    function move() {
        let x = container.offsetWidth / 2 + radius * Math.cos(angle) - particle.offsetWidth / 2;
        let y = container.offsetHeight / 2 + radius * Math.sin(angle) - particle.offsetHeight / 2;
